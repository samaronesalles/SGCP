...
uses
  ...
  type
    ...
    private
      ...
      function idHttpSendReq(EnderecoWEB, CustonHeaders: Widestring; VAR Resposta: Widestring; VAR StatusCode: Longint): Boolean;
...
begin
  ...
  Try
    Try
      ...
      StatusCode:= Self.FStatusCode;

      if NOT idHttpSendReq(EnderecoWEB, CustonHeaders, Resposta, StatusCode) then
        Exit;
...
begin
  ...
  Self.FRetorno.StatusCode:= Self.FStatusCode;
  Self.FRetorno.Erro:= Self.FStatusCode <> 200;
  Self.FRetorno.Data:= Uteis.ReturnValor_EmJSON(Self.FResposta, 'data');

end;

function TThr_Api.idHttpSendReq(EnderecoWEB, CustonHeaders: Widestring; VAR Resposta: Widestring; VAR StatusCode: Longint): Boolean;
var
  lHTTP                                                                         : TIdHTTP;
